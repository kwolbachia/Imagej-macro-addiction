...
var ShortcutsMenu = newMenu("Custom Menu Tool",
	newArray("Max from virtual stack","Set selection size...","Note in infos","Rotate 90 Degrees Right","Rotate 90 Degrees Left","Plot Z-axis Profile","-","Gaussian Blur...","Gaussian Blur 3D...","Gamma...",
		 "-","test all Z project", "test CLAHE options","slow CLAHE", "Temporal-Color Code", "Tempo color no Zproject","test all color blindness","gauss correction","mean corr by slices","-","Batch convert ims to tif","Batch convert 32 to 16-bit",
		 "-","Neuron (5 channels)","HeLa Cells (48-bit RGB)","Fluorescent Cells", "Confocal Series","Mitosis (5D stack)","M51 Galaxy (16-bits)","-","invertableLUTs","CB_Bar","JeromesWheel","RGBtimeIsOver"));
